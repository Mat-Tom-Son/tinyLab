...
gpt2_small_delta_ld = np.array(
    [
        ...
        0.04,
        0.06,
        0.329,  # Heads 0-7 (2,4,7 are coalition)
        0.02,
        0.04,
        0.03,
        0.05,  # Heads 8-11
...
gpt2_medium_delta_ld = np.array(
    [
        ...
        0.05,
        0.07,
        0.335,  # Heads 0-7 (2,4,7 conserved!)
        0.03,
        0.05,
        0.04,
        0.06,  # Heads 8-11
...
# Heatmap
im = ax.imshow(
    data_matrix, cmap="Blues", aspect="auto", vmin=0, vmax=0.6, interpolation="nearest"
)
...
for head_idx in gpt2_coalition:
    ax.text(
        head_idx,
        0,
        f"{gpt2_small_delta_ld[head_idx]:.2f}",
        ha="center",
        va="center",
        fontsize=6,
        fontweight="bold",
    ...
    ax.text(
        head_idx,
        1,
        f"{gpt2_medium_delta_ld[head_idx]:.2f}",
        ha="center",
        va="center",
        fontsize=6,
        fontweight="bold",
...
for head_idx in mistral_coalition:
    ax.text(
        head_idx,
        2,
        f"{mistral_delta_ld[head_idx]:.2f}",
        ha="center",
        va="center",
        fontsize=6,
        fontweight="bold",
...
ax.text(
    ...
    fontweight="bold",
    bbox=dict(
        boxstyle="round,pad=0.3", facecolor="white", edgecolor="red", linewidth=1.5
    ),
)
...
ax.text(
    ...
    fontweight="bold",
    bbox=dict(
        boxstyle="round,pad=0.3", facecolor="white", edgecolor="#06A77D", linewidth=1.5
    ),
)

# Title
ax.set_title(
    "Cross-Architecture Validation: Layer-0 Hedging Motif",
    fontsize=11,
    fontweight="bold",
    pad=10,
)
