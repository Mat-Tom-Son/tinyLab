...
3. **Mistral experiments** – `lab/configs/run_h1_cross_condition_balanced_mistral*.json` cover the per-condition sweeps (now defaulting to seeds `[0,1,2]`); pair/triplet follow-ups live alongside (`run_h5_*mistral*.json`).
